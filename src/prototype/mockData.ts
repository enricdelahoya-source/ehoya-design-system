...
export const EXAMPLE_CASES: CaseRecord[] = [
  ...
  buildCaseRecord({
    ...INITIAL_CASE_RECORD,
    id: "CASE-10537",
    title: "Finance team is validating restored invoice portal access after account repair",
    status: "in_progress",
    signals: createCaseSignals({
      waitingOnCustomer: true,
    }),
    ...
    checkpoint: "Follow up on Apr 2, 2026",
    reason:
      "A corrective update was sent after the account state and finance roles were resynchronized. The case should stay open until the customer confirms portal access is restored.",
    blockingReason: "awaiting_customer_validation",
    priority: "High",
    assignee: "Amelie Laurent",
    queue: "Platform Escalations",
    statusReason: "Account state and affected finance roles were resynchronized; customer confirmation is now pending before closure.",
    onHoldUntil: "2026-04-02",
    channel: "Email",
    severity: "Major",
    productArea: "Billing Portal",
    ...
    approvalReason: "",
    description:
      "Finance users could not access the billing portal after repeated password resets. Support corrected the account state and resynchronized the affected finance roles, then asked the customer to confirm access is restored.",
    internalNotes:
      "Platform Escalations owns the case while customer validation is pending. Do not close until the customer confirms the affected users can sign in and see invoices.",
